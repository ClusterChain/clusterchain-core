package org.clusterchain.crypto;
...
import org.clusterchain.config.Constants;
import org.clusterchain.crypto.jce.ECKeyAgreement;
import org.clusterchain.crypto.jce.ECKeyFactory;
import org.clusterchain.crypto.jce.ECKeyPairGenerator;
import org.clusterchain.crypto.jce.ECSignatureFactory;
import org.clusterchain.crypto.jce.SpongyCastleProvider;
...
import static org.clusterchain.util.BIUtil.isLessThan;
import static org.clusterchain.util.ByteUtil.bigIntegerToBytes;
...
public class ECKey implements Serializable {
   ...
   */
  public static class ECDSASignature implements Serializable{
    /**
...
//        try{
//            throw new IOException("recoverPubBytesFromSignature");
//        } catch(IOException e) {
//            e.printStackTrace();
//        }
